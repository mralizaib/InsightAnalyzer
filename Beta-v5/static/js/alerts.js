...
function deleteAlert(alertId) {
    ...
    fetch(`/api/alert_configs/${alertId}`, {
        ...
        .then(data => {
            ...
            if (successMessage) {
                successMessage.textContent = data.message || 'Alert configuration deleted successfully!';
            }
            successModal.show();
        })
        .catch(error => {
            ...
            const errorMessage = document.getElementById('error-message');
            if (errorMessage) {
                errorMessage.textContent = `Error deleting alert: ${error.message}`;
            }
            errorModal.show();
        });
}
...
function handleCreateAlert(event) {
    ...
    fetch('/api/alert_configs', {
        ...
        .then(data => {
            ...
            const successMessage = document.getElementById('success-message');
            if (successMessage) {
                successMessage.textContent = data.message || 'Alert configuration created successfully!';
            }
            successModal.show();
        })
        .catch(error => {
            ...
            const errorMessage = document.getElementById('error-message');
            if (errorMessage) {
                errorMessage.textContent = `Error creating alert: ${error.message}`;
            }
            errorModal.show();
        });
}
...
loadingModal.hide();
            ...
            const successMessage = document.getElementById('success-message');
            if (successMessage) {
                successMessage.textContent = data.message || 'Alert configuration updated successfully!';
            }
            successModal.show();
        })
        .catch(error => {
            ...
            const errorMessage = document.getElementById('error-message');
            if (errorMessage) {
                errorMessage.textContent = `Error updating alert: ${error.message}`;
            }
            errorModal.show();
        });
}
